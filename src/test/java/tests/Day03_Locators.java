...
public class Day03_Locators {
    WebDriver driver; //declare in the class level
    @Before
    public void setUp(){
...
//      NOTE : We do not need to use containers. We can use method chain in selenium(GOOD FOR MEMORY)
...
//        driver.findElement(By.tagName("button")).click();
        ...
        //2.Or we can locate a CORE ELEMENT on the default page to assert is that element display on the page
        ...
        Assert.assertEquals("LOGIN FAILED",actualURL,expectedURL); //If login success PASS, if it does not success, FAIL and print message LOGIN FAILED
